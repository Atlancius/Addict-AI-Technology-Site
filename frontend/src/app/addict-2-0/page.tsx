    ...
    <>
      ...
      <main>
        ...
        <section className="min-h-[70vh] flex items-center pt-24 pb-16 relative">
          ...
          <div className="absolute top-1/4 -right-32 w-[500px] h-[500px] bg-flame/5 rounded-full blur-3xl -z-10" />

          <div className="max-w-7xl mx-auto px-6 w-full">
            <ScrollReveal>
              <div className="inline-flex items-center gap-2 px-3 py-1 border-l-2 border-flame bg-surface-1/60 mb-6">
              ...
              <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-text-primary leading-tight mb-6">
                Réparation rapide,
                <br />
                <span className="text-flame">boutique tech, café manga</span>
              </h1>
